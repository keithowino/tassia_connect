...
export default function Admin() {
	...
	// 			posts: statsData.totalPosts || postsRes.data?.length || 0,
	// 		});
	// 	} catch (error) {
	...
	// 		// IMPORTANT: Extract posts from the nested structure
	...
	// 			orders: statsData.totalOrders || 0,
	// 			reviews: statsData.totalReviews || reviewsRes.data?.length || 0,
	// 			posts: statsData.totalPosts || postsData.length || 0,
	// 		});
	// 	} catch (error) {
	// 		console.error("Error fetching admin data:", error);
	// 		setError("Failed to load admin data. Please try again.");
