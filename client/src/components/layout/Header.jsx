			...
			<div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between gap-3">
				...
				<div className="flex items-center gap-2">
					...
					>
						<ShoppingCart size={20} className="text-gray-600" />
						{/* {itemCount > 0 && (
							<span className="absolute -top-0.5 -right-0.5 min-w-[20px] h-5 bg-orange-500 text-white text-xs rounded-full flex items-center justify-center font-bold px-1.5">
