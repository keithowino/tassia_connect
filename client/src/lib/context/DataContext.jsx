...
export const DataProvider = ({ children }) => {
	...
	const dummyBusinesses = [
		...
		},
		{
			...
			owner_id: 104,
			avatar_url:
				"https://images.unsplash.com/photo-1585747860715-2ba37e788b70?q=80&w=200&auto=format&fit=crop",
			latitude: -0.4178,
			longitude: 36.9512,
			verified: true,
			status: "active",
		...
		},
		{
			...
			owner_id: 106,
			avatar_url:
				"https://images.unsplash.com/photo-1578916171728-46686eac8d58?q=80&w=200&auto=format&fit=crop",
			latitude: -0.4142,
			longitude: 36.9485,
			verified: false,
			status: "pending",
		...
		},
		{
			...
			owner_id: 116,
			avatar_url:
				"https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=200&auto=format&fit=crop",
			latitude: -0.4215,
			longitude: 36.9537,
			verified: true,
			status: "active",
		...
		},
		{
			...
			owner_id: 117,
			avatar_url:
				"https://images.unsplash.com/photo-1523413651479-597eb2da0ad6?q=80&w=200&auto=format&fit=crop",
			latitude: -0.4231,
			longitude: 36.9548,
			verified: true,
			status: "active",
		...
		},
		{
			...
			owner_id: 118,
			avatar_url:
				"https://images.unsplash.com/photo-1562967914-608f82629710?q=80&w=200&auto=format&fit=crop",
			latitude: -0.4192,
			longitude: 36.9515,
			verified: true,
			status: "active",
		...
		},
		{
			...
			owner_id: 119,
			avatar_url:
				"https://images.unsplash.com/photo-1559847844-5315695dadae?q=80&w=200&auto=format&fit=crop",
			latitude: -0.4175,
			longitude: 36.9503,
			verified: false,
			status: "suspended",
		...
		},
		{
			...
			owner_id: 121,
			avatar_url:
				"https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?q=80&w=200&auto=format&fit=crop",
			latitude: -0.4245,
			longitude: 36.9557,
			verified: true,
			status: "active",
		...
		},
		{
			...
			owner_id: 122,
			avatar_url:
				"https://images.unsplash.com/photo-1606755962773-d324e0a13086?q=80&w=200&auto=format&fit=crop",
			latitude: -0.4205,
			longitude: 36.9528,
			verified: true,
			status: "active",
